...
use super::{ChunkCache, ChunkCacheTypeDecoded};

impl<TStorage: ?Sized + ReadableStorageTraits + 'static>
    ArrayChunkCacheExt<TStorage, ChunkCacheTypeDecoded> for Array<TStorage>
{
    fn retrieve_chunk_opt_cached(
        &self,
        cache: &impl ChunkCache<ChunkCacheTypeDecoded>,
        chunk_indices: &[u64],
...
mod tests {
    ...
    use crate::{
        array::{
            ArrayBuilder, ChunkCacheDecodedLruChunkLimit, ChunkCacheDecodedLruSizeLimit, DataType,
            FillValue,
        },
        array_subset::ArraySubset,
